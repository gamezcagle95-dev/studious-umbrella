...
class AppraisalParams:
    """Container for appraisal signing parameters to satisfy Pylint."""
    asset_hash_hex: str
    price_eit_base: int
    ipfs_cid: str
    nonce: int
...
def sign_appraisal_eip712(params: AppraisalParams) -> str:
    ...
    signed_msg = Account.sign_message(signable_message=structured_msg, private_key=params.private_key)
