...
from appraisal_engine import calculate_appraisal, usd_to_eit_base_units, sign_appraisal_eip712
...
def run_integration_test() -> None:
    ...
    signature = sign_appraisal_eip712(
    ...
    # 5. Local Cryptographic Assertions (EIP-712)
    eip712_payload = {
        "types": {
            "EIP712Domain": [
